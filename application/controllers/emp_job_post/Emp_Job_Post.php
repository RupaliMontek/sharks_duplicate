...
class Emp_Job_Post extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('emp_job_post/M_emp_job_post');
    ...
    //     $this->db->query("use " .$db_name. "");
		...
		$data['list_job_post']=$this->M_emp_job_post->list_emp_job_post();
	//	print_r($data['list_job_post']);exit;
		$this->load->view('template/header');
		$this->load->view('template/sidebar_admin');
		$this->load->view('emp_job_post/list_emp_job_post',$data);
	}
