...
<div class="modal fade homeloginbuttonmodal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <button id="g-signin2" type="button" class="btn btn-primary signingoogle">
        <a href="<?= base_url('auth/googleLogin'); ?>" style="text-decoration: none; color: white;">Sign In with Google</a>
    </button>
 <button  id="g-signin2"type="button" class="btn btn-primary signingoogle">
 <a class="link login" href="<?php echo base_url('linkedin/login'); ?>"> <img src="linkedin-icon.png" /> Login with LinkedIn</a>
 </button>
</div>
