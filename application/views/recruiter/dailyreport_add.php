...
<form method="post" name="addCandidate" id="addCandidate" action="<?php echo base_url('recruiter/recruiter/save');?>"  enctype="multipart/form-data"           onsubmit="return validateFP_email_id();">                   
                <input type="hidden" name="company_client" id="company_client" class="form-control">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3">
                       ...
                       <input type="text" placeholder="Contact No" name="contact_no" id="contact_no" minlength="10" maxlength="12" class="form-control"   onblur="checkIDAvailability();" >
...
<script type="text/javascript">
  ...
  $(document).ready( function() 
    ...
    return this.optional(element) || /^[a-zA-Z\s]*$/.test(value);}, "only character allowed.");
