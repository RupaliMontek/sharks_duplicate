...
<form method="post" name="addCandidate" id="addCandidate" action="<?php echo base_url('recruiter/recruiter/save_candidate_entry_by_vendor');?>"  enctype="multipart/form-data"           onsubmit="return validateFP_email_id();">                   
...
<div class="row">
    <div class="col-md-3">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" id="date" class="form-control" name="date"  placeholder="Select date" autocomplete="off">
                         <input type="hidden" id="job_profile_id" class="form-control" name="job_profile_id" value="<?php echo $job_profile_id; ?>">
                      </div>
 ...
 <div class="row">
                      ...
                      <div class="col-md-4">
                          <label>Position / Skills<font color="red">*</font></label>
                      ...
                      <div class="col-md-4">
                           <label>Candidate Name<font color="red">*</font></label>
...
<div class="row">
                      ...
                      <div class="col-md-4">
                           <label>Yrs of Experience (Years n Months) <font color="red">*</font></label>
                           <div class="frslectoptionnn">
                      ...
                      <div class="col-md-4">
                          <label>Relevant Exp <font color="red">*</font></label>
...
<div class="row">
                      ...
                      <div class="col-md-4">
                          <label>CTC (In Lakhs & Thousands) <font color="red">*</font></label>
                          <div class="frslectoptionnn">
 ...
 <div class="row">
                <div class="col-md-4">
                          <label>Official / Onpaper Notice Period</label>
...
<div class="col-md-4">
    <select class="form-control" name="final_status" id="final_status">
                           ...
                           <option value="HR Hold">HR Hold</option>
...
<div class="row">
                      ...
                      <div class="col-md-4">
                          <label>Upload Resume <font color="red">*</font></label>
                  ...
                  <br>
                  <div class="col-md-12">
            <h4><input type="hidden" name="genuinity_check" value="0">
            <input type="checkbox" name="genuinity_check" id="genuinity_check" value="1">Genuinity</h4>
