  ...
  <div class="row">
    ...
    <div class="press-box">
      ...
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-6">
            <h2 class="popup"><?php  echo $education_de ?> </h2>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal_it_skill-body">
                    <div class="col-md-12">  
                    <form id="add_education" method="POST" action="<?php echo base_url();?>recruitment/save_candidate_employment_details"> 
                      <div class="row">
                 ...
                 <div class="modal-footer">
                    <button type="button"  class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button id="education_sumbit" type="button" onclick="ajaxformsubmit()" class="btn btn-secondary" >Save</button>
                </div>   
                 </form>
                </div>
                </div>
    ...
    <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-6">
            <h2 class="popup">Personal Details&nbsp;<i onclick="edit_personal_details(<?php echo @$personal_details[0]->personal_id ?>)" style="color:blue" class="fa fa-pencil" aria-hidden="true"></i></h2>
            <div class="row">
                <div  class="form-group col-md-6">
                          <small>Gender</small>                          
                    ...
                    <form id="add_personal_deatils" method="POST" action="<?php echo base_url();?>recruitment/save_personal_details_candidate"> 
                      <div class="row">
                        <div  class="form-group col-md-12">
                           ...
                           <input name="gender2" id="gender" type="radio" value="Female" />
                           <label for="gender2">Female</label>
                           <input name="gender3" id="gender" type="radio" value="Transgender" />
                                        ...
                                        <tbody style="height: 100px">
                                          <div id="tasskkdf_1">
                                                <tr id="add_more_1" style="position:sticky; top: 0;">
                                                  ...
                                                  <input type="checkbox" id="lang_read" name="lang_read[]" value="Read">&nbsp;
                                                  <label>Read</label>
                                                  <input type="checkbox" id="lang_write_" name="lang_write[]"                         value="Write">&nbsp;
                                                  <label>Write</label>
                                                  <input type="checkbox" id="lang_speak_" name="lang_speak[]" value="Speak">&nbsp;
                                                  <label>Speak</label>
...
<script type="text/javascript">
 ...
 function add_more_task_eng(count){
    ...
    new_row_eng+='<td><input type="text" class="form-control" name="language_add[]" id="language_add'+counter_eng+'" placeholder="Enter Language"><br><input type="checkbox" id="lang_read_'+counter_eng+'" name="lang_read[]" value="Read">&nbsp<label>Read</label>&nbsp;<input type="checkbox" id="lang_write'+counter_eng+'" name="lang_write[]" value="Write">&nbsp<label>Write</label>&nbsp;<input type="checkbox" id="lang_speak'+counter_eng+'" name="lang_speak[]" value="Speak">&nbsp<label>Speak</label></td>';
   ...
   new_row_eng+='<td><button type="button" id="del_more_row_eng_'+counter_eng+'"  class="btn btn-info btn-sm" onClick="delete_more_row_eng('+counter_eng+')">Delete</button></td>';
    ...
    $('#example8').append(new_row_eng);
     $('.exp_class').datepicker({
    format: 'dd/mm/yyyy'
  });
   $('.exp1_class').datepicker({
    format: 'dd/mm/yyyy'
  });
  $(".exp_class").datepicker({
    autoclose: true,
    ...
    // alert(minDate);
    $('.exp1_class').datepicker('setStartDate', minDate);
  });
...
$(".exp1_class").datepicker({
    ...
    var minDate = new Date(selected.date.valueOf());
    $('.exp_class').datepicker('setenddate', minDate);
  });
 }
