                    ...
                    <div class="form-group col-md-3">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                      <select class="form-control" name="candidate_working_from_yr">       
                                         ...
                                         <?php for($startYear=1997; $startYear<=2020; $startYear++){ ?>
                            ...
                            <div class="form-group col-md-5">
                                 <select class="form-control js-example-tokenizer" name="candidate_specialization" id="candidate_specialization">       
                            ...
                            <div class="form-group col-md-6">
								...
								<textarea name="candidate_university" class="form-control" placeholder="Select university/institute" id="candidate_university" cols="10" rows="2"><?=@$candidate->candidate_university_institute?></textarea>
							</div>
							</div>
							  <div class="row">
                                <label class="form-group col-md-3"></label>
						...
						<div class="row">
                                ...
                                <div class="form-group col-md-3">
                                 <label class="checkbox-inline">
                                      <input type="checkbox" name="candidate_job_type" <?php if(@$candidate->candidate_notice_period=="Serving Notice Period"){echo "selected";}?>>Permanent
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="candidate_job_type" <?php if(@$candidate->candidate_notice_period=="Serving Notice Period"){echo "selected";}?>>Contractual
                                </label>
                                </div>
                        </div>
                      	<div class="row">
                                ...
                                <div class="form-group col-md-3">
                                 <label class="checkbox-inline">
                                      <input type="radio" name="candidate_employment_type" <?php if(@$candidate->candidate_notice_period=="Serving Notice Period"){echo "checked";}?>>Full Time
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="radio" name="candidate_employment_type" <?php if(@$candidate->candidate_notice_period=="Serving Notice Period"){echo "checked";}?>>Part Time
                                </label>
                                </div>
                      </div>
                        <div class="row">
                             ...
                             <div class="form-group col-md-3">
                                 <label class="radio-inline">
                                      <input type="radio" name="candidate_prefered_shift" <?php if(@$candidate->candidate_preferred_shift=="Serving Notice Period"){echo "checked";}?>>Day
                                    </label>
                                    <label class="radio-inline">
                                      <input type="radio" name="candidate_prefered_shift" <?php if(@$candidate->candidate_preferred_shift=="Serving Notice Period"){echo "checked";}?>>Night
                                </label>
                                <label class="radio-inline">
                                      <input type="radio" name="candidate_prefered_shift" <?php if(@$candidate->candidate_preferred_shift=="Serving Notice Period"){echo "checked";}?>>Flexible
                                </label>
                            </div>
                            </div>
                         ...
                         <div class="row">
                            ...
                            <div class="form-group col-md-5">
                                 <select class="form-control" name="candidate_desired_location" id="candidate_desired_location">       
                        ...
                        <div class="row">
                            ...
                            <label class="form-group col-md-2">Gender</label>
                              <div class="form-group col-md-6">
                                    <label class="radio-inline">
                                      <input type="radio" name="candidate_gender">Male
                                    </label>
                                    <label class="radio-inline">
                                      <input type="radio" name="candidate_gender">Female
                                    </label>
                                     <label class="radio-inline">
                                      <input type="radio" name="candidate_gender">Transgender
                                    </label>
                             </div>
                        </div>
                         <div class="row">
						...
						<div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="radio-inline">
                                  <input type="radio" name="candidate_differently_abled" checked="">Yes
                                </label>
                                <label class="radio-inline">
                                  <input type="radio" name="candidate_differently_abled">No
                                </label>
                            </div>
                        </div>
                        <div class="row">
						...
						<div class="row">
                               ...
                               <div class="form-group col-md-3">
                                 <label class="radio-inline">
                                      <input type="radio" name="candidate_differently_proficiency_type" checked="">Read
                                    </label>
                                    <label class="radio-inline">
                                      <input type="radio" name="candidate_differently_proficiency_type">Write
                                  </label>
                                  <label class="radio-inline">
                                      <input type="radio" name="candidate_differently_proficiency_type">Speak
                                  </label>
                            </div>
                            </div>
