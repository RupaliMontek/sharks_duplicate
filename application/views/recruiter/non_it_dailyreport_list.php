...
<div class="box">
<div class="box box-solid box-info" style="padding: 45px;">
<?php   $user_role = $this->session->userdata('user_role');  if($user_role==2 OR $user_role==9 OR $user_role==1011 OR $user_role==10) {  ?>
...
<a href="<?php echo base_url();?>recruiter/recruiter/add_non_it"><button type="button" class="btn btn-warning btn-md pull-right"  >Add Individual Report</button></a>
</div>
<?php } ?>
<form class="form-horizontal" name="search_room" id="search_room" action="<?php echo base_url();?>recruiter/recruiter/search_details_not_it" method="POST">
...
<?php } ?>   
<div class="col-md-2" id="skillwise_report_div_qqq">
...
<label class="control-label col-md-12">D/W Clientwise Individual Report</label> 
<div class="col-md-3">                       
...
<?php $user_role = $this->session->userdata('user_role'); if($user_role==2 OR $user_role==9 OR $user_role==10) { ?>
<div class="col-md-3">
<form class="form-horizontal" name="search_room" id="search_room" action="<?php echo base_url();?>recruiter/recruiter/full_excel_non_it" method="POST">
...
<div class="col-md-3">
<label class="control-label col-md-12">Recruiter Individual Report</label> 
<div class="col-md-12">                       
...
<div class="row col-md-4 padd_top mar_top_0">
...
<div class="row">
<div class="col-md-4">
<h3>Recruiter Candidate Data</h3>
</div>
...
<select class="form-control" name="min_exp" value="" style="width:50%;float:left;">
...
<select class="form-control" name="max_exp" value="" style="width:50%;float:right;">
