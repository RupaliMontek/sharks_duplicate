...
<head>
   ...
   <link rel='stylesheet' id='nokri-theme-style-css'  href='<?php echo base_url()?>asset/wp-content/themes/nokri/css/theme5b21.css?ver=6.0.2' type='text/css' media='all' />
        ...
        <div class="container-fluid">
            <ul class="list-unstyled topnav-menu float-end mb-0">
                ...
                <li class="d-none d-lg-block">
                    <form class="app-search" method="post" action="<?php echo base_url();?>candidate_profile/search_job_main">
                        <div class="app-search-box dropdown">
                            <div class="input-group">
                                <input type="search" class="form-control" placeholder= "Search job here..." id="top-search" name="top-search">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                              ...
                              <!--  <a href="javascript:void(0);" class="dropdown-item notify-item">
                                ...
                                <a href="<?php echo base_url();?>candidate_profile/edit_profile" class="dropdown-item notify-item">
                                 ...
                                 <a href="<?php echo base_url();?>candidate_profile/edit_resumes" class="dropdown-item notify-item">
                                    <i class="fe-user"></i>
