...
<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <script>document.write(new Date().getFullYear())</script> &copy;<a href="http://montekservices.com/">Montek Services</a> 
            </div>
            <div class="col-md-6">
            ...
            <div class="tab-pane" id="chat-tab" role="tabpanel">
                ...
                <div class="p-2">
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?php echo base_url();?>assets/image/users/user-10.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?php echo base_url();?>assets/image/users/user-1.jpg" class="rounded-circle avatar-sm" alt="user-pic">
...
var check = function() {
    ...
    document.getElementById('candidate_confirm_password').value) {
    ...
    function candidate_data_add(){
     var base_url = '<?php echo base_url(); ?>'; 
     
     window.location.href =base_url+"candidate_profile/candidate_registration";
/*$.ajax({
      url: base_url+'candidate_profile/candidate_registration',
      type: 'POST',
      dataType:'json',
      data:{
        },
...
<!-- Mirrored from coderthemes.com/ubold/layouts/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Sep 2022 07:18:57 GMT -->
</html>