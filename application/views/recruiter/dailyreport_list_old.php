...
<script type="text/javascript">
 ...
 <form class="form-horizontal" name="search_room" id="search_room" action="<?php echo base_url();?>recruiter/recruiter/search_details" method="POST">
      ...
      <?php  $user_role = $this->session->userdata('user_role');  if($user_role==5) {  ?>
       <div class="col-md-3">
      <div class="box-body">
            <label class="control-label col-md-12">Clientwise Candidate</label> 
              <div class="col-md-12">                       
      ...
      <?php } ?>   
       <div class="col-md-3" id="skillwise_report_div_qqq">
        <div class="box-body">
           <?php  $user_role = $this->session->userdata('user_role');  if($user_role==2 OR $user_role==5) {  ?>
            <label class="control-label col-md-12">Select Skill</label> 
              <div class="col-md-8">   
...
<option value="<?php echo $row['position_skills']; ?>" ><?php echo $row['position_skills']; ?></option>
            ...
            <?php }else { ?>
              <div class="col-md-4 mar_top_0" style="padding-top: 35px;">
                <input type="submit" class="btn btn-success" value="Search" name="Search" /> 
              </div>
            <?php } ?>
            </div>
     ...
     <!-- <div id="abcd">
      ...
      <div class="col-md-6">
        <div class="box-body">
              ...
              <div class="col-md-4 padd_top mar_top_0">
