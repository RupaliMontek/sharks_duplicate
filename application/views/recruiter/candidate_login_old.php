    ...
    <div class="flex-r login-wrapper">
      <div class="login-text">
        ...
        <form action="<?php echo base_url();?>Candidate_profile_login/check_user_login_check_candidate" name="user_login" id="user_login" method="post">
          ...
          <input class="btn" type="submit" onclick="if(!this.form.checkbox.checked){alert('You must agree to the terms first.');return false}"  value="Login"><br>
          <span class="extra-line">
            <span>if not registered then
            <a href="<?php echo base_url()?>Recruitment">register here</a>
            
          </span>
          <br>
            <div class="col-md-12"> 
           <a href="#"  onclick="func()">Forgot your password?</a>
            </div>
        </form>
    ...
    $("#user_login").validate(
    {
      ...
      rules: 
      {
        email: 
        {
          ...
          emailtest:true,
          remote: {
                url: base_url+"candidate_profile_login/check_email_exists",
                type: "post",
                data: {
                    email: function() {
                        return $("#email").val();
        ...
        password: 
        {
          required:true,
          remote: {
                url: base_url+"candidate_profile_login/check_password_exist",
                type: "post",
                data: {
                    email: function() {
                        return $("#email").val();
