                              ...
                              <div class="row">
                                ...
                                <div id="wrapper">
                                 ...
                                 <div class="col-md-10 tuple">
                                     <h1><?=$candidate_profile[0]->candidate_name?></h1>
                                    ...
                                    <!--</div>-->
                                     <div class="col-md-12">
                                         <div class="row">
                                        <div class="col-md-3">
                                            <p><i class="fa fa-suitcase" aria-hidden="true"></i> <?=$candidate_profile[0]->yrs_of_experience?>yr <?=$candidate_profile[0]->months_of_experience?>m </p>
                                        </div>
                                        <div class="col-md-3">
                                             <p><i class="fa fa-rupee">Rs </i><?=$candidate_profile[0]->ctc?></p>
                                        </div>
                                        <div class="col-md-3">
