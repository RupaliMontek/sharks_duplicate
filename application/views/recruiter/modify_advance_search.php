             ...
             <div class="form-row">
              <div class="row">
                ...
                <div class="form-group col-md-5">
                  <input type="text" class="form-control" autocomplete="off" placeholder="Enter keywords like skills, designation and company" name="any_keywords" id="any_keywords" value="<?php if(!empty($_SESSION['search_data']['any_keywords'])){ echo $_SESSION['search_data']['any_keywords'];} ?>">
                 ...
                 <!--     <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-5">
                          <input type="text" class="form-control " autocomplete="off" placeholder="Enter keywords like skills, designation and company" name="excluding_keywords" id="excluding_keywords" value="<?php if(!empty($_SESSION['search_data']['excluding_keywords'])){echo $_SESSION['search_data']['excluding_keywords'];} ?>">
                    <!--<select id="excluding_keywords" name="excluding_keywords[]" class="form-control js-example-tokenizer" multiple="multiple">       
                      ...
                      <div class="row">
                        ...
                        <?php  for($i=0; $i<=30; $i++){ ?>
                                    <option <?php if($_SESSION['search_data']['total_experience_from'] ==$i){ echo "selected"; }?>  value="<?= $i; ?>"><?= $i; ?></option>
                            <?php } ?>
                                </select> 
                          </div>
                          ...
                          <div class="form-group col-md-2">
                            ...
                            <?php  for($i=0; $i<=50; $i++){ ?>
                                    <option <?php if($_SESSION['search_data']['total_experience_to'] ==$i){ echo "selected"; }?>   value="<?= $i; ?>"><?= $i; ?></option>
                            <?php } ?>
                                </select>
                          </div>
                        ...
                        <!--<div class="row">-->
                          ...
                          <!--<div class="form-group col-md-2">-->
                            ...
                            <?php  for($i=100000; $i<=30000000; $i++){ ?>
                                    <option <?php if($_SESSION['search_data']['anual_salary_from_lacs']==$i){echo "selected"; }  ?> value="<?= $i; ?>"><?= $i; ?></option>
                            <?php } ?>
                                  </select>
                                </div>
                            ...
                            <?php  for($i=100000; $i<=30000000; $i++){ ?>
                                    <option <?php if($_SESSION['search_data']['anual_salary_to_lacs']==$i){echo "selected"; }?> value="<?= $i; ?>"><?= $i; ?></option>
                            <?php } ?>
                                  </select>
                                </div>
                           <!--     <label class="form-group col-md-1">To</label>
                   ...
                   <!--             <div class="form-group col-md-1">
                              ...
                              <div class="form-group col-md-5">
                                ...
                                <select id="current_location" name="current_location" class="form-control js-example-tokenizer">       
                                  ...
                                  if(!empty($location))
                                  {
                                    ...
                                    {
                                        $selected = strcasecmp($_SESSION['search_data']['current_location'], $row->location) === 0 ? 'selected' : '';
                                      ?>
                                      <option  <?= $selected ?> <?php if($_SESSION['search_data']['current_location'] ==$row->location){ echo "selected"; }?> value="<?php  echo $row->location; ?>"><?php  echo $row->location; ?></option>
                                      <?php
                                    }
                                  }
                                  ?>
                        ...
                        <div class="row">
                          ...
                          <?php 
                            if(!empty($location))
                            {
                              foreach($location as $row)
                              {
                                  $selected = strcasecmp($_SESSION['search_data']['prefered_location'], $row->location) === 0 ? 'selected' : '';
                                ?>
                                <option <?= $selected ?>      <?php if($_SESSION['search_data']['prefered_location'] ==$row->location){ echo "selected"; }?> value="<?php  echo $row->location; ?>"><?php  echo $row->location; ?></option>
                                <?php
                              }
                            }
                          ?>
                      ...
                      <?=$_SESSION['search_data']['current_location'] ?>
