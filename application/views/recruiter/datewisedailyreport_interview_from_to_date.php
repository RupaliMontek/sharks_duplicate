<script type="text/javascript">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Daily Interview Report</h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="javascript:void(0);">Daily Interview Report</a></li>
      </ol>
    </section>
          ...
          <div class="box">
            <div class="panel panel-info">
              <div class="box-body">
                ...
                echo form_open_multipart('Recruiter_Reports/download_dailyreport_interview_confirmed', $attributes);?>
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>From Date</label>
                        <input type="text"id="fromdate" class="form-control" name="from_date" required />
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>To Date</label>
                        <input type="text"id="todate" class="form-control" name="to_date" required/>
                      </div>
                    </div>
