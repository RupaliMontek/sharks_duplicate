              ...
              <tbody>
                ...
                if(!empty($list_dailyreport))
                {
                  ...
                  foreach($list_dailyreport as $row)
                  {
                    ...
                    if($user_role==1)
                    {?>
                                                          <td> <a class="btn btn-primary" href="<?php echo base_url();?>recruiter/recruiter/view_screenshots/<?php echo $row['dailyreport_id'] ;?>">View</a></td>
                                                          <?php }?>
                                                          <td>  
...
<?php } ?>
<?php if(!empty($list_dailyreport)){ ?> <p>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Transfer Candidate To Another Recruiter</h4>
            </div>
              ...
              <div class="row">
                <div class="center col-md-12">
                  <input type="hidden" id="dailyreport_id_sourced_by" name="dailyreport_id_sourced_by">
                   ...
                   <?php
                    $query=$this->db->query("SELECT user_admin_id, name, l_name FROM  user_admin where (role=2 || role=5 || role=9 || role=10 || role=1011) AND status=1 ");
