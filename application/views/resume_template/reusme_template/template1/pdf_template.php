        ...
        <?php if(!empty($user_details)){$profile_image = base_url($user_details[0]->image);} ?>
          ...
          <div class="wrapper-3">
            ...
            <div class="phone">
              ...
              <p class="text-11"><?php if(!empty($user_details)){ @$user_details[0]->contact; } ?></p>
            </div>
          </div>
          <div class="wrapper-5">
            ...
            <div class="email">
              ...
              <p class="text-12"><?php if(!empty($user_details)){ @$user_details[0]->email; } ?></p>
            </div>
          </div>
...
<div class="software-skill group">
    ...
    <div class="row match-height group">
        <?php 
        if (!empty($candidate_skils->skills)) {
            $skills = explode(",", $candidate_skils->skills);
            ...
            foreach ($skills as $index => $row) {
                // Determine the column class based on index
        ...
        ?>        
                <p class="text-33"><?php echo htmlspecialchars($row); ?></p>
