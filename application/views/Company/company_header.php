...
<div class="modal fade homeloginbuttonmodal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <button  id="g-signin2"type="button" class="btn btn-primary signingoogle"><a href="<?php echo @$login_google; ?>">Sign In with Google</a></button>
</div>
<form class="getotpform">
  <div class="form-group">
    <label for="exampleInputEmail1">Mobile Number</label>
  <input type="phone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your 10 digit mobile no.">
...
<!--modal end here -->
      ...
      <button type="button" class="btn-link nav-item dropdown fremployers">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a href="<?php echo base_url("Job_post"); ?>" class="dropdown-item">Post a job</a>
          <!--<a class="dropdown-item" href="#">Buy online</a>-->
          <a class="dropdown-item" href="<?php echo base_url(); ?>Company/">Recruiters Login</a>
        </div>
      </button>
    </div>
    <!-- right div end here --->
