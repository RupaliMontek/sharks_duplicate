...
<form action="<?php echo base_url() ?>company/save_sharks_company_form" method="post"  enctype="multipart/form-data">
...
<div class="bottom">
  <pre id="log"></pre>
     ...
     <label for="recordedVideo">Record Video</label>
         <label for="recordedVideo">Record Video</label>
        <video id="preview" width="400" height="300" autoplay controls></video>
          <video id="recording" width="160" height="120" controls></video>
...
function startRecording() {
    navigator.mediaDevices.getUserMedia({
        ...
        mediaRecorder.onstop = () => {
            ...
            fetch('<?php echo base_url('company/save_sharks_company_form'); ?>', {
                method: 'POST',
                body: formData
            })
...
document.querySelector('form').addEventListener('submit', function(e) {
    // Append the recorded video data to the form data
